...
Make an account on <a href="https://rstudio.cloud" target="_blank">RStudio Cloud</a>.

Use your Argosy Gmail account to make signing-in easier.
</br></br>
...
Copy the code below and paste it into an *R file*, then click `Source`. The initial download may take a few minutes.</br>
...
For a `table` with 2 or more columns, the data used in most examples is:
...
Custom functions will use specific types of data that may vary.


For advanced figures, the data used for the examples is pre-installed in *RStudio*. The data set refers to different car models, which is shown below:
